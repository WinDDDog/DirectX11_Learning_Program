...
void DrawFunction::RenderScene()
{
	...
	View_World = DirectX::XMMatrixRotationY(t) * DirectX::XMMatrixTranslation(0.0f, 0.0f, 1.0f);//按y转换
	...
	devContext->PSSetShaderResources(0, 1, &pTextureRV);//texture
...
HRESULT DrawFunction::CompileTheShader(void)
{
	...
	//Load Texture
	//加载纹理资料
	hr = DirectX::CreateDDSTextureFromFile(dev, L"seafloor.dds", nullptr, &pTextureRV);//记得release
	if (FAILED(hr))
		return hr;
...
HRESULT DrawFunction::CreateGraph(void)
{
	...
	{	//正面
		{ DirectX::XMFLOAT3(+1.0f, +1.0f, +0.0f), DirectX::XMFLOAT2(0.0f, 0.0f) },//红
		{ DirectX::XMFLOAT3(+1.0f, -1.0f, +0.0f), DirectX::XMFLOAT2(0.0f, 1.0f) },//黄
		{ DirectX::XMFLOAT3(-1.0f, -1.0f, +0.0f), DirectX::XMFLOAT2(1.0f, 1.0f) },//蓝
		{ DirectX::XMFLOAT3(-1.0f, +1.0f, +0.0f), DirectX::XMFLOAT2(1.0f, 0.0f) },//绿
		//反面
		{ DirectX::XMFLOAT3(+1.0f, +1.0f, -0.1f), DirectX::XMFLOAT2(0.0f, 0.0f) },
		{ DirectX::XMFLOAT3(+1.0f, -1.0f, -0.1f), DirectX::XMFLOAT2(0.0f, 1.0f) },
		{ DirectX::XMFLOAT3(-1.0f, -1.0f, -0.1f), DirectX::XMFLOAT2(1.0f, 1.0f) },
		{ DirectX::XMFLOAT3(-1.0f, +1.0f, -0.1f), DirectX::XMFLOAT2(1.0f, 0.0f) }
	};
