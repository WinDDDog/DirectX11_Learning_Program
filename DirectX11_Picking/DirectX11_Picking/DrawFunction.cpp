...
HRESULT DrawFunction::CreateGraph(void)
{
	...
	*/
	...
	back_View__ = DirectX::XMMatrixInverse(&DirectX::XMMatrixDeterminant(View_View), View_View);

	View_Projection = DirectX::XMMatrixPerspectiveFovLH(DirectX::XM_PIDIV2, Width / (FLOAT)height, 0.01f, 100.0f);
